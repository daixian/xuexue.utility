...
namespace xuexue.LitJson
{
    ...
    public class JsonMapper
    {
                                        ...
                                        int depth)
        {
            ...
            //如果定义了这个对象应该被忽略
            if (JsonTypeRegister.listIgnoreClass.Contains(obj_type))
            {
                return;
            }

            //xuexueJsonClass xxjc = obj.GetType().GetCustomAttribute<xuexueJsonClass>();
            //if (xxjc.intermediary != null)
            //{
            //    IIntermediary obj_im = Activator.CreateInstance(xxjc.intermediary) as IIntermediary;
            //    obj_im.InitWithTarget(obj);//从目标类型读值
            //    obj = obj_im;
            //    obj_type = xxjc.intermediary;//目标类型已经没用了，全部换过来
            //}
            #endregion
        ...
        public static void OverrideObject(string json, object obj)
        {
            if (obj == null)
            {
                return;
            ...
            {
                throw new Exception("JsonMapper.OverwriteObject():函数只能用于引用类型对象。");
            }

            JsonReader reader = new JsonReader(json);
            ReadValue(obj.GetType(), reader, obj);
            return;
        }
        ...
        /// <param name="obj"></param>
        public static void OverrideObject(TextReader reader, object obj)
        {
            if (obj == null)
            {
                return;
            ...
            JsonReader json_reader = new JsonReader(reader);
            ReadValue(obj.GetType(), json_reader, obj);
            return;
        }
        ...
        /// <param name="reader"></param>
        /// <param name="obj"></param>
        public static void OverrideObject(JsonReader reader, object obj)
        {
            if (obj == null)
            {
                return;
